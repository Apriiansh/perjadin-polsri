        ...
        <div class="bg-white rounded-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="perihal" rows="2" class="input-control" placeholder="Contoh: Undangan Mengikuti Kegiatan RESD Phase 2" required><?= esc($travelRequest->perihal ?? '') ?></textarea>
                </div>
                <div>
