...
class TravelMemberModel extends Model
{
    ...
    {
        return $this->select('travel_members.*, employees.name as employee_name, employees.nip as employee_nip, employees.pangkat_golongan as employee_golongan, travel_members.kode_golongan, travel_members.nama_golongan')
