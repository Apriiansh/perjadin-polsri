...
class TravelExpenseModel extends Model
{
    ...
    {
        return $this->select('travel_expenses.*, travel_members.employee_id, travel_members.no_sppd, travel_members.tgl_sppd, employees.name as employee_name, employees.nip as employee_nip, employees.pangkat_golongan as employee_golongan')
